...
export default function NewQuizPage() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            if (res.ok) {
                toast.success("Đã tạo câu đố mới!");
    ...
    const handleCopyAIInstructor = () => {
        const prompt = `Hãy đóng vai một chuyên gia soạn thảo câu hỏi trắc nghiệm Triết học Mác-Lênin. Tôi cần bạn tạo một bộ Quiz theo cấu trúc JSON sau:
{
  "title": "Tiêu đề Quiz (Ví dụ: Trắc nghiệm Quy luật Lượng - Chất)",
  "topicSlug": "slug-bai-hoc-tuong-ung",
  "xpReward": 100,
  "questions": [
    {
      "question": "Nội dung câu hỏi?",
      "options": ["Phương án A", "Phương án B", "Phương án C", "Phương án D"],
      "correctAnswer": 0, (Chỉ số của câu trả lời đúng từ 0-3)
      "explanation": "Giải thích tại sao đáp án đó đúng"
    }
  ]
}
Hãy tạo ít nhất 5 câu hỏi cho chủ đề: [CHÈN CHỦ ĐỀ Ở ĐÂY]. Trả về CHỈ mã JSON.`;
        navigator.clipboard.writeText(prompt);
        toast.success("Đã sao chép hướng dẫn AI cho Quiz!");
    };
        ...
        <div className="max-w-5xl mx-auto px-4 py-12 space-y-12 animate-fade-in">
            <header className="flex flex-col md:flex-row justify-between items-start md:items-end gap-6">
                <div className="space-y-4">
                    ...
                    <h1 className="text-4xl font-black italic uppercase tracking-tighter flex items-center gap-3">
                        <Gamepad2 className="text-primary w-10 h-10" /> Thiết kế Quiz Mới
                    </h1>
                </div>
                ...
                <div className="flex gap-3">
                    ...
                    <Button variant="outline" onClick={handleCopyAIInstructor} className="rounded-xl border-primary/20 bg-primary/5 text-primary gap-2">
                        <Bot className="w-4 h-4" /> AI Quiz Helper
                    </Button>
                </div>
            </header>
            ...
            <form onSubmit={handleSubmit} className="space-y-12">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8 relative z-10">
                        <div className="space-y-3">
                            ...
                            <input
                                ...
                                placeholder="Ví dụ: Quiz Quy luật Lượng - Chất"
                                required
                            />
                        </div>
                        <div className="space-y-3">
                            ...
                            <input
                                ...
                                placeholder="quy-luat-luong-chat"
                                required
                            />
                        </div>
                        <div className="space-y-3">
                ...
                <div className="space-y-8">
                    <div className="flex justify-between items-center px-4">
                        <h2 className="text-2xl font-black italic flex items-center gap-3">
                            <HelpCircle className="text-primary w-6 h-6" /> Danh sách Câu hỏi
                        </h2>
                            ...
                            <Card key={qIdx} className="glass border-white/5 rounded-[2.5rem] p-8 space-y-8 relative group">
                                ...
                                <div className="space-y-4">
                                    ...
                                    <textarea
                                        ...
                                        placeholder="Ví dụ: Quy luật nào chỉ ra cách thức của sự vận động?"
                                        required
                                    />
                                </div>
                                ...
                                <div className="space-y-3">
                                    ...
                                    <textarea
                                        ...
                                        placeholder="Tại sao đáp án này chính xác?"
                                        required
                                    />
                                </div>
                            </Card>
                ...
                <div className="pt-8 flex flex-col md:flex-row gap-6">
                    ...
                    >
                        {isSubmitting ? "Đang lưu giữ liệu..." : "Lưu & Xuất Bản Quiz"} <Save className="ml-3" />
                    </Button>
